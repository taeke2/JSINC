		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu" id="nav-accordion">
					...
					<!-- 주소록 -->
					<li>
						<a class="active" href="addressBook">
									...
									<c:forEach items="${mg }" var="dto_mem">
										<tr class="gradeA">
											...
											<td align="center"><button type="button"
													class="btn btn-info"
													onclick="location.href='mesWriteView?empNo=${dto_mem.empNo }&rank=${dto_mem.rank }&name=${dto_mem.name }&dep=${dto_mem.dep }'">메세지
													전송</button></td>
										</tr>
									</c:forEach>
									<!-- 개발부 -->
	...
	<script type="text/javascript">
		...
		$(document).ready(
				function() {
					 ...
					 */
					// by성택_1번째(이름)를 내림차순 정렬_20200528
